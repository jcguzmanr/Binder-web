...
export const DiagnosticoLegalOpsPageGateStart = () => {
  ...
  const breadcrumbs = [
    { label: 'Inicio', path: '/' },
    { label: 'Diagnóstico Legal Ops (Formulario al inicio)', path: '/diagnostico-legal-ops-formulario-inicio' },
  ];
  ...
  const validateGate = (): boolean => {
    ...
    if (!gateFormData.email.trim()) {
      errors.email = 'El email corporativo es requerido.';
    } else if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(gateFormData.email)) {
          ...
          <section className="diagnostico-stage">
            <div className="container">
              <div className="diagnostico-card">
                ...
                <p>
                  Déjanos tus datos para enviarte el resultado y una guía breve con acciones por nivel.
                </p>
                  ...
                  <div className="diagnostico-form-grid">
                    <label>
                      ...
                      <input
                        ...
                        onChange={(event) => setGateFormData((prev) => ({ ...prev, name: event.target.value }))}
                    ...
                    <label>
                      ...
                      />
                      {gateErrors.email && <span className="error-text">{gateErrors.email}</span>}
                    </label>
                    ...
                    <label>
                      ...
                      <input
                        ...
                        onChange={(event) => setGateFormData((prev) => ({ ...prev, company: event.target.value }))}
                        className={gateErrors.company ? 'error' : ''}
                      />
                      {gateErrors.company && <span className="error-text">{gateErrors.company}</span>}
                    </label>
